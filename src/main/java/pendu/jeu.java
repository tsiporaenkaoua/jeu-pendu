...
public class jeu {
	...
	//compare et affiche les lettres du mot trouvées
		public static String displayLetterFound(String word) {
			...
			String letter = sc.nextLine();//on ne peut pas directement récuperer un char
			
			if(!word.contains(letter)) {// ou word.indexOf(letter)==-1
				System.out.println("La lettre " + letter + " ne se trouve pas dans le mot secret.");
			}else {
